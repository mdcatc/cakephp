 ...
 * (webapp Name) base name is 'cache'
 * controller is 'cacheTest'
 * action is 'cache_name'
 ...
 **/
	...
	$this->Controller->cache_parsing();
        ...
        //This leaves the path as 'Test/_name' when str_replace is used
        //because the word cache is replaced in all occurances.
        //we expect the match to look like cacheTest/cache_name
